const products = [
    {
        ...
        description: 'Experience immersive sound with our premium wireless headphones. Features active noise cancellation, 40-hour battery life, and premium comfort.',
        brand: 'AudioPro',
    ...
    },
    {
        ...
        description: '4K professional camera with included lenses. Perfect for photography enthusiasts and professionals alike.',
        brand: 'SnapPro',
        category: 'Cameras',
        price: 155000,
        countInStock: 5,
    ...
    },
    {
        ...
        description: 'Premium leather backpack with laptop compartment. Perfect for travel and daily commutes.',
        brand: 'TravelCo',
        category: 'Bags',
        price: 21500,
        countInStock: 12,
