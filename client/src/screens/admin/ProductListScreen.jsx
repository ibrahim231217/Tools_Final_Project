      ...
      >
                  ...
                  <td className="px-8 py-6 text-right">
                    <div className="flex items-center justify-end gap-3">
                      <Link
                        ...
                        className="p-2 rounded-full hover:bg-[#B08D55]/10 text-secondary hover:text-[#B08D55] transition-colors"
                      >
                        <Edit2 size={18} />
                      </Link>
                      <button
        ...
        <div className="p-6 border-t border-[#2c2926]/5 flex justify-between items-center text-sm text-secondary flex-shrink-0">
          ...
          <div className="flex gap-2">
            <button className="px-4 py-2 rounded-lg hover:bg-white/50 disabled:opacity-50">
              Previous
            </button>
            <button className="px-4 py-2 rounded-lg hover:bg-white/50 disabled:opacity-50">
              Next
